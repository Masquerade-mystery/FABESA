...
def run_kpabe(pairing_group, attr_list, policy_str, msg):  
    ...
    with open('Results/New KP-ABE Results2.txt', 'a') as f:
        ...
        f.write(record_6 + '\n')               
        f.write('\n')     
    open('Results/New KP-ABE Results2.txt', 'r')  
    with open('Results/New KP-ABE Results2.txt', 'a') as f:     
        f.write('*' * 62 + '\n')            
    return       
...
def run_cpabe(pairing_group, attr_list, policy_str, msg):     
    ...
    with open('Results/New CP-ABE Results2.txt', 'a') as f:
        f.write('CP-ABE: ' + 'Running times (ms) curve MNT224: n1={}  n2={}  m={}  i={}'.format(n1, n2, m, i) + '\n')
        f.write(algo_string + '\n')
        f.write(record_1 + '\n') 
        f.write(record_2 + '\n') 
        f.write(record_3 + '\n') 
        ...
        f.write(record_7 + '\n')  
        f.write('\n')     
    open('Results/New CP-ABE Results2.txt', 'r')  
    with open('Results/New CP-ABE Results2.txt', 'a') as f:     
        f.write('*' * 62 + '\n')            
    return          
